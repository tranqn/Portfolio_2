/**
 * Centralized registry of all image asset paths served from `public/img/`.
 *
 * Organized by section so components reference paths via
 * `IMAGE_PATHS.SECTION.ASSET` instead of raw strings.
 */
export const IMAGE_PATHS = {
  ...
  SKILLS: {
    ...
    TAILWIND: 'img/skills/tailwind.svg',
    THREEJS: 'img/skills/threejs.svg',
  ...
  PROJECTS: {
    ...
    VIDEOFLIX: 'img/projects/videoflix.png',
    CODERR: 'img/projects/coderr.png',
    QUIZLY: 'img/projects/quizly.png',
