...
export class SkillDataService {
  private readonly skills = signal<SkillItem[]>([
    ...
    { icon: IMAGE_PATHS.SKILLS.PYTHON, name: 'Python' },
    { icon: IMAGE_PATHS.SKILLS.DJANGO, name: 'Django' },
    { icon: IMAGE_PATHS.SKILLS.POSTGRESQL, name: 'PostgreSQL' },
    { icon: IMAGE_PATHS.SKILLS.DOCKER, name: 'Docker' },
